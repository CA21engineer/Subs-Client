...
struct SlidingTabView: View {
    ...
    init(selection: Binding<Int>,
         ...
         activeAccentColor: Color = .primary,
         inactiveAccentColor: Color = Color.primary.opacity(0.4),
         selectionBarColor: Color = .primary,
         inactiveTabColor: Color = .init(UIColor.systemBackground),
         activeTabColor: Color = .init(UIColor.systemBackground),
